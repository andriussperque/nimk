...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", './cssCompletion', 'vscode-nls'], factory);
    }
    ...
    var SCSSCompletion = (function (_super) {
        ...
        SCSSCompletion.prototype.createFunctionProposals = function (proposals, existingNode, result) {
            var _this = this;
            var replaceFunction = function (match, p1) { return p1 + ': {{' + (SCSSCompletion.variableDefaults[p1] || '') + '}}'; };
            proposals.forEach(function (p) {
                result.items.push({
                    label: p.func.substr(0, p.func.indexOf('(')),
                    detail: p.func,
                    documentation: p.desc,
                    textEdit: _this.getTextEdit(existingNode, p.func.replace(/\[?(\$\w+)\]?/g, replaceFunction)),
                    kind: 3 /* Function */
                });
            });
            return result;
